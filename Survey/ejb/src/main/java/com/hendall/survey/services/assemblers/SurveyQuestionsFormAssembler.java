...
import com.hendall.survey.services.schematopojo.HtmlControl;
...
public class SurveyQuestionsFormAssembler {
	...
	public static void populateSections(ClassName suvey, List<Section> sectionsList) {
		...
		if (CollectionUtils.isNotEmpty(suvey.getSection())) {
			for (com.hendall.survey.services.schematopojo.Section jsonSection : suvey.getSection()) {
				...
				if (CollectionUtils.isNotEmpty(jsonSection.getQuestion())) {
					for (com.hendall.survey.services.schematopojo.Question jsonQuestion : jsonSection.getQuestion()) {
